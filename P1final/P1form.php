  ...
  <table id="q2table" class="table" >
    ...
    <tr>
      ...
      <label for="cuisine5"><input type="checkbox" id="cuisine5" name="Seafood" value="Yes">
        ...
        <td>
      <label for="cuisine6"><input type="checkbox" id="cuisine6" name="Herby" value="Yes">
        Herby</label><br>
        </td>
    </tr> 
  </table>
...
<div id="q6" class="hide">
    <p id="q6text" class="question">Favorite Architecture?</p>
      ...
      <tr>
        <td>
      <label for="beachstyle">
      <input type="radio" id="beachstyle" name="architecture" value="beachstyle">
      Beachside</label>
        </td>
        <td>
      <label for="ancient">
...
<div id="submit" class="hide"> 
    ...
    <p>Name<p>
    <input type="text" name="name" class="submitinfo" required>
    <p>Age<p>
    <input type="number" name="age" class="submitinfo" required>
    <p>Email<p>
    <input type="email" name="email" class="submitinfo" required><br>
    <p>Phone Number<p>
    <input type="number" name="phone" class="submitinfo" required><br>
    <p>City<p>
    <input type="text" name="city" class="submitinfo" required><br>
    <p>State<p>
    <input type="text" name="state" class="submitinfo" required><br><br>
